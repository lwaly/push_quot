...
#define SET_TMP_ERR_INFO(x, args...)           \
    ...
    typedef struct QUOT_CONFIG
    {
        int8 iSupportsSearch;
        int8 iSupportsGroupRequest;
        char   szSupportedResolutions[32];
        int8   iSupportsMarks;
        int8   iSupportsTime;
        ...
        {
            iSupportsSearch = 0;
            iSupportsGroupRequest = 0;
            iSupportsMarks = 0;
            iSupportsTime = 0;
            memset(szSupportedResolutions, 0, sizeof(szSupportedResolutions));
        }
        ...
        QUOT_CONFIG(const QUOT_CONFIG& obj)
        {
            *this = obj;
        }

        QUOT_CONFIG& operator = (const QUOT_CONFIG& obj)
        {
            if (this == &obj)
                return *this;
            iSupportsSearch = obj.iSupportsSearch;
            iSupportsGroupRequest = obj.iSupportsGroupRequest;
            iSupportsMarks = obj.iSupportsMarks;
            iSupportsTime = obj.iSupportsTime;
            snprintf(szSupportedResolutions, sizeof(szSupportedResolutions), obj.szSupportedResolutions);

            return *this;
        }
    }QUOT_CONFIG, *LPQUOT_CONFIG;
